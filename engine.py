...
# =====================================================================
# 📋 ВІШЛИСТ СПРАЙТІВ ТА НАЗВИ ФАЙЛІВ ДЛЯ ПАПКИ assets/sprites/
# =====================================================================
# Переконайся, що твої картинки підписані СТРОГО так, як нижче:
#
# 1. Гравець та інтерфейс:
#    - assets/sprites/icon.png          -> Іконка вікна гри (32х32)
#    - assets/sprites/player.png        -> Спрайт персонажа (32х32)
#    - assets/sprites/battery_hud.png   -> Рамка шкали заряду сонара (150х15)
#
# 2. Об'єкти рівнів (Текстури стін та підлоги):
#    - assets/sprites/wall_tutorial.png -> Стіна для туторіалу (50х50)
#    - assets/sprites/wall_bunker.png   -> Стіна поіржавілого бункеру (50х50)
#    - assets/sprites/wall_mine.png     -> Стіна кристалічної шахти (50х50)
#    - assets/sprites/wall_lab.png      -> Стіна кібер-лабораторії (50х50)
#    - assets/sprites/finish.png        -> Спрайт виходу/люка (50х50)
#    - assets/sprites/battery_item.png  -> Спрайт батарейки на землі (24х24)
#
# 3. Вороги:
#    - assets/sprites/enemy_bunker.png  -> Сліпий дроїд-охоронець (32х32)
#    - assets/sprites/enemy_mine.png    -> Підземний хробак/мутант (32х32)
#    - assets/sprites/enemy_lab.png     -> Прототип "Мисливець" (32х32)
#
# 4. Катсцени (Зображення міняються під сюжет):
#    - assets/sprites/intro1.png        -> Запуск системи, аварія
#    - assets/sprites/intro2.png        -> Опис темряви сховища
#    - assets/sprites/intro3.png        -> Падіння робота
#    - assets/sprites/intro4.png        -> Пошкоджені сенсори
#    - assets/sprites/intro5.png        -> Активація акустичного сонару
# =====================================================================
...
LEVELS = [
    ...
    # Рівень 3 (Кристалічні печери) — ПОВНІСТЮ ПЕРЕРОБЛЕНО. Тепер це велика відкрита зала!
    [
        "WWWWWWWWWWWWWWWW",
        "WP.............W",
        "W....WW....WW..W",
    ...
    # Рівень 4 (Кібер-лабораторія) — Коридори розширено, щоб легше маневрувати
    [
        "WWWWWWWWWWWWWWWW",
        "WP......B......W",
        "W...WWWWWWWW...W",
    ...
    # Рівень 5 (Сектор ядра) — Фінал. Простора арена з двома швидкими ворогами
    [
        "WWWWWWWWWWWWWWWW",
        "WP.............W",
        "W....W.....W...W",
...
class Enemy:
    def __init__(self, x, y, level_idx):
        ...
        if level_idx == 5:
            self.speed = 4  # У секторі ЯДРА монстри шалені
        else:
            self.speed = 2
